...
$sql = "INSERT INTO trabajo_transporte (hora_inicio,hora_termino,id_trabajador,id,estado) VALUES ('".$_POST['hora_inicio']."','".$_POST['hora_termino']."','".$_POST['trabajadores']."','".$_POST['lugar']."','".$_POST['estado']."')";
