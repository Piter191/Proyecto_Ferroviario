...
<body>
	<form method="POST" action="../controladores/ctrl_trabajo_modificar_despachador.php" onsubmit="funcionSubmit(event)">
		...
		<input type="text" style="display: none;" name="id_trabajo_transporte" value="<?php echo $_GET['id_trabajo_transporte'] ?>">
			...
			<p>
				<center> <label for="fecha_inicio">Fecha de Inicio</label>
					<input class="input-time" type="date" name="fecha_inicio" id="fecha_inicio"  style="width:250px" value="<?php echo $user['fecha_inicio'] ?>" required >
				</center>
			</p>
			<p>
				<center> <label for="hora_inicio">Hora de Inicio</label>
					<input class="input-time" type="time" name="hora_inicio" id="hora_inicio" style="width:250px" value="<?php echo $user['hora_inicio'] ?>" required>
				</center>
			</p>
			<p>
				<center> <label for="fecha_termino">Fecha de Termino</label>
					<input class="input-time" type="date" name="fecha_termino" id="fecha_termino" style="width:250px" value="<?php echo $user['fecha_termino'] ?>" required>
				</center>
			</p>
			<p>
				<center> <label for="hora_termino">Hora de Termino</label>
					<input type="time" name="hora_termino" id="hora_termino" style="width:250px" value="<?php echo $user['hora_termino'] ?>" required>
				</center>
			</p>
			<p>
