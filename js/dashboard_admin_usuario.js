    ...
    function (data, textStatus, jqXHR) {  // success callback
        ...
        users.forEach(user => {
            ...
            <tr>
                ...
                <td> 
                  <a class="btn btn-primary"  href="./formulario_usuario_modificar.php?id_usuario=${user.id_usuario}"  role="button">
                    <i class="icon ion-md-hammer"></i>
                  </a> 

                  <a class="btn btn-primary"  href="./eliminar_usuario.php?id_usuario=${user.id_usuario}"  role="button">
